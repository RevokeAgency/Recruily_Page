...
const testimonials: Testimonial[] = [
  ...
  },
  {
    id: 4,
    quote:
      "The ROI has been incredible. We've saved thousands in recruitment costs while improving the quality of our hires.",
    author: "David Kim",
    position: "COO",
    company: "GrowthWave",
  },
  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-center">
        ...
        <div className="w-full overflow-hidden px-4 py-12">
          <div className="flex flex-col items-center space-y-4">
            <Card className="w-full max-w-3xl border-none bg-slate-50 shadow-sm">
      ...
      <div className="mt-12 flex flex-wrap items-center justify-center gap-8">
        ...
        <div className="h-8 w-24 opacity-70 grayscale transition-all hover:opacity-100 hover:grayscale-0">
          <Image src="/placeholder.svg?height=32&width=96&text=GrowthWave" alt="GrowthWave" width={96} height={32} />
        </div>
      </div>
    </div>
  )

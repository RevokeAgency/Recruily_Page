          ...
          <InviteCandidatesModal
            ...
            onCandidateAdded={(newCandidate) => {
              setCandidates(prev => [{
                ...
                overall_score: newCandidate.match_score || 75,
                skills_score: newCandidate.skills_score || 0,
                experience_score: newCandidate.experience_score || 0,
                education_score: 75,
                languages_score: 80,
                certifications_score: 70,
                other_score: 75,
                strengths: Array.isArray(newCandidate.strengths) ? newCandidate.strengths : [],
                gaps: Array.isArray(newCandidate.gaps) ? newCandidate.gaps : [],
                recommendations: Array.isArray(newCandidate.recommendations) ? newCandidate.recommendations : [],
